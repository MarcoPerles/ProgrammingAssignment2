...
They don’t calculate the mean, they simply store the value of the input in a variable m. into the main function makeVector (setmean) and return it (getmean).
...
The following function computes the inverse of the special “matrix” (which is the input of cachemean) returned by makeCacheMatrix. 
